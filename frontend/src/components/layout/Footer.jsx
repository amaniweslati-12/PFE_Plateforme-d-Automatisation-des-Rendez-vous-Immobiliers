        ...
        <footer className="footer">
            <div className="container">
                    ...
                    <div className="footer-section">
                        <div className="footer-logo">
                            ...
                            <span className="footer-brand">
                                <span className="brand-main">DUBAI</span>
                                <span className="brand-sub">LUXURY PROPERTIES</span>
                            </span>
                        </div>
                        <p className="footer-desc">
                            Discover the finest luxury properties in Dubai. Your gateway to exclusive real estate opportunities.
                        </p>
                ...
                <div className="footer-bottom">
                    <p>&copy; {currentYear} Dubai Luxury Properties. All rights reserved.</p>
